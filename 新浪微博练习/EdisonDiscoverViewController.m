//
//  EdisonDiscoverViewController.m
//  新浪微博练习
//
...
@interface EdisonDiscoverViewController ()

@end

@implementation EdisonDiscoverViewController
...
{
    [super viewDidLoad];
    EdisonSearBar *searchBar = [EdisonSearBar searchBar];
